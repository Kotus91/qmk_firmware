...
[_AZERTY] = {
  ...
  {KC_NO,   FR_W,    FR_X,    FR_C,    FR_V,    FR_B,                      FR_N,    FR_COMM, FR_DOT,  FR_COLN, FR_EXLM, KC_ENT},
  {KC_LCTL, KC_APP,  KC_LALT, KC_LGUI, LOWER,   KC_SPC, KC_SPC,   RAISE,   KC_SPC,  RAISE,   KC_LEFT, KC_UP,   KC_DOWN, KC_RGHT}
  },
